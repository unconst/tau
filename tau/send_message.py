...
Usage:
    python -m tau.send_message "Your message here"
    python -m tau.send_message "Task completed successfully"
    python tau/send_message.py "Your message here"
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m tau.send_message \"your message\"", file=sys.stderr)
        sys.exit(1)
